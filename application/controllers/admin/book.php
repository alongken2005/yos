...
class Book extends CI_Controller
{
    ...
    */
    public function lists () {
		...
		$total_num = $this->base->get_data('book')->num_rows();
		...
		$this->gpagination->target(site_url('admin/book/lists'));

		$this->_data['pagination'] = $this->gpagination->getOutput();
		$this->_data['lists'] = $this->base->get_data('book', array(), '*', $limit, $offset)->result_array();
